...
const Checkout = () => {
  ...
  const [accountId, setAccountId] = useState('');
   const [tppPin, setTppPin] = useState("");
  ...
  return (
    <div className="checkout-container">
      ...
      <div style={{ display: 'flex', alignItems: 'center' }}>
            <label style={{ marginRight: '10px' }}>Enter TPP Pin:</label>
            <input
              type="password"
              value={tppPin}
              onChange={(e) => setTppPin(e.target.value)}
              style={{ width: '100px', height: '20px', fontSize: '14px', padding: '5px' }}
            />
          </div>
